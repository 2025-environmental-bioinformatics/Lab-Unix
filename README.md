...
As reminder here is what the 📂 Folder structure looked like in the GUI 

![File Structure](https://github.com/2025-environmental-bioinformatics/Lab-Unix/blob/main/images/File_structure.png)

Here, check the Folder Structure by listing all its contents (and including detailed information)
